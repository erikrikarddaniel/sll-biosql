...
ActiveRecord::Schema.define(:version => 20120713133000) do
  ...
  add_index "bioentry", ["accession", "biodatabase_id", "version"], :name => "bioentry_accession_biodatabase_id_version_key", :unique => true
  add_index "bioentry", ["biodatabase_id"], :name => "bioentry_db"
  add_index "bioentry", ["identifier", "biodatabase_id"], :name => "bioentry_identifier_biodatabase_id_key", :unique => true
  ...
  add_index "bioentry_path", ["object_bioentry_id", "subject_bioentry_id", "term_id", "distance"], :name => "bioentry_path_object_bioentry_id_subject_bioentry_id_term_i_key", :unique => true
  ...
  add_index "bioentry_qualifier_value", ["bioentry_id", "term_id", "rank"], :name => "bioentry_qualifier_value_bioentry_id_term_id_rank_key", :unique => true
  ...
  add_index "bioentry_relationship", ["object_bioentry_id", "subject_bioentry_id", "term_id"], :name => "bioentry_relationship_object_bioentry_id_subject_bioentry_i_key", :unique => true
  ...
  add_index "comment", ["bioentry_id", "rank"], :name => "comment_bioentry_id_rank_key", :unique => true
  ...
  add_index "dbxref", ["accession", "dbname", "version"], :name => "dbxref_accession_dbname_version_key", :unique => true
  ...
  add_index "location", ["seqfeature_id", "rank"], :name => "location_seqfeature_id_rank_key", :unique => true
  ...
  create_table "protein_gi_taxons", :primary_key => "protein_gi", :force => true do |t|
    t.integer "taxon_id"
  end
  ...
  add_index "seqfeature", ["bioentry_id", "type_term_id", "source_term_id", "rank"], :name => "seqfeature_bioentry_id_type_term_id_source_term_id_rank_key", :unique => true
  ...
  add_index "seqfeature_path", ["object_seqfeature_id", "subject_seqfeature_id", "term_id", "distance"], :name => "seqfeature_path_object_seqfeature_id_subject_seqfeature_id__key", :unique => true
  ...
  add_index "seqfeature_relationship", ["object_seqfeature_id", "subject_seqfeature_id", "term_id"], :name => "seqfeature_relationship_object_seqfeature_id_subject_seqfea_key", :unique => true
  ...
  create_table "sequenced_genomes", :primary_key => "ncbi_taxon_id", :force => true do |t|
    t.boolean "wgs"
  end
  ...
  add_index "taxon_name", ["name", "name_class", "taxon_id"], :name => "taxon_name_name_name_class_taxon_id_key", :unique => true
  ...
  add_index "term", ["name", "ontology_id", "is_obsolete"], :name => "term_name_ontology_id_is_obsolete_key", :unique => true
  ...
  add_index "term_path", ["subject_term_id", "predicate_term_id", "object_term_id", "ontology_id", "distance"], :name => "term_path_subject_term_id_predicate_term_id_object_term_id__key", :unique => true
  ...
  add_index "term_relationship", ["subject_term_id", "predicate_term_id", "object_term_id", "ontology_id"], :name => "term_relationship_subject_term_id_predicate_term_id_object__key", :unique => true
